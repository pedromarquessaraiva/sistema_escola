            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i>Cadastro de Aluno
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                   
					<!--xxxxxxxxxxxxxxxxxcadastrando PHPxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx-->
...
<?php
	...
	$com = "INSERT INTO responsavel(nome,usuario,senha,email)
	...
	echo "<br/>Foi gravado as informações do(a) Responsável(a)<h3>$nome</h3>";
	 echo "<br/><a class='btn' href='formulario_responsavel.php'>Voltar ao cadastro</a>";
