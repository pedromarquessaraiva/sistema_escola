...
<title>Cadastro do Responsavel</title>
...
>>>>>>> Links
                        ...
                        <li>
                            <a class="active" href="formulario_responsavel.php"><i class="fa fa-male fa-fw"></i> Cadastro do Responsável</a>
                        </li>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-male fa-fw"></i>Cadastro do Responsavel
                        </div>
                        <!-- /.panel-heading -->
    ...
    <form role="form" name="formulario_resposavel" method="POST" action="cadastro_responsavelbd.php">
