            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-trash fa-fw"></i>Excluir Cadastro
                        </div>
			 ...
			 <div class="panel-body">
					...
					<form role="form" name="formulario_editar" method="POST" action="listaexcluir_bd.php">
						<div class="row">
						...
						<div class="col-lg-8 col-md-8">	
							<label>Sua Pesquisa:</label>
							<div class="form-group">		
								<input class="form-control" type="text" name="buscar" placeholder="insira sua Pesquisa" required>
							</div>
						</div>
						</div>
